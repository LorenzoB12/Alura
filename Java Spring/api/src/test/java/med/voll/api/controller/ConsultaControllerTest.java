...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Teste para validar erro 400 quando não for passado nenhum parâmetro na requisição")
    ...
    @Test
    @DisplayName("Teste para validar retorno 200 quando for passado os parâmetros corretos na requisição")
